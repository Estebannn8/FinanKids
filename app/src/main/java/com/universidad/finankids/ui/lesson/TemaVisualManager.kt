...
object TemaVisualManager {
    ...
    private val temasPorCategoria = mapOf(
        ...
        "basica" to TemaVisual(
            ...
            fillBlankBackground = R.drawable.fill_blank_background_banco,
            multipleChoiceBackground = R.drawable.multiple_choice_background_banco,
            sentenceBuilderBackground = R.drawable.sentence_builder_background_banco,
        ...
        "inversion" to TemaVisual(
            ...
            teachingBackground = R.drawable.teaching_background_inversiones,
            fillBlankBackground = R.drawable.fill_blank_background_inversiones,
            multipleChoiceBackground = R.drawable.multiple_choice_background_inversiones,
        ...
        "compra" to TemaVisual(
            ...
            teachingBackground = R.drawable.teaching_background_centro_comercial,
            fillBlankBackground = R.drawable.fill_blank_background_centro_comercial,
            multipleChoiceBackground = R.drawable.multiple_choice_background_centro_comercial,
            sentenceBuilderBackground = R.drawable.sentence_builder_background_centro_comercial,
